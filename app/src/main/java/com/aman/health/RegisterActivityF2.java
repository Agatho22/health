        ...
        mBtnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(strPwd.equals(strPwd2)) {
                    ...
                    final ProgressDialog mDialog = new ProgressDialog(RegisterActivityF2.this);
                    mDialog.setMessage("가입중입니다...");
                    mDialog.show();

                    //파이어베이스에 신규계정 등록하기
                    mfirebaseAuth.createUserWithEmailAndPassword(strEmail, strPwd).addOnCompleteListener(RegisterActivityF2.this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(RegisterActivityF2.this, "이미 존재하는 아이디 입니다.", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(RegisterActivityF2.this, "비밀번호가 틀렸습니다. 다시 입력해 주세요.", Toast.LENGTH_SHORT).show();
                    return;
                }
            }
        });
